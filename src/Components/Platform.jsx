                      ...
                      />
                              ...
                              <div style={messagesStyle}>
                                  <BotMessage baseSize={baseSize} textWhite={textWhite}>
                                      Hello! I'm your AI assistant. I'm here to help with any questions you have about our platform. What would you like to know?
                                  </BotMessage>

                                  <UserMessage baseSize={baseSize} textWhite={textWhite} orange={orange} red={red}>
                                      What features does your platform offer?
                                  </UserMessage>

                                  <BotMessage baseSize={baseSize} textWhite={textWhite}>
                                      Great question! We offer neural processing for intelligent responses, adaptive learning that improves over time, real-time insights with comprehensive analytics, multi-language support, enterprise-grade security, and seamless integrations with 50+ platforms.
                                  </BotMessage>
                              ...
                              <div className="glass-card" style={inputCardStyle}>
                                  ...
                                  />
                                  <button style={sendButtonStyle(orange, red)} onClick={() => {window.location.href="/chatbot"}}    >
                                      ➤
                                  </button>
                              </div>
                          </div>
                          ...
                          <div style={statsGridStyle}>
                              <StatCard label="Response Time" value="< 100ms" {...{ baseSize, orange, red, textWhite }} />
                              <StatCard label="Availability" value="24/7" {...{ baseSize, orange, red, textWhite }} />
                              <StatCard label="Accuracy Rate" value="95%" {...{ baseSize, orange, red, textWhite }} />
                          </div>
